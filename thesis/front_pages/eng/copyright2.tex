...
The provided source code of the thesis, its results, and the software developed
for this purpose are licensed under the MIT License. This means they may be
freely distributed and/or modified under its terms, and are available at
\url{\linktosourcecode}. Details of the license are available on the website at 
