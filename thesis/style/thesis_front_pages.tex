...
\usepackage{tikz}
\usetikzlibrary{
    arrows.meta, decorations.pathmorphing, calc, fadings,
    shapes.geometric, shapes.multipart, positioning}
\tikzfading[name=fade out,
  inner color=transparent!0,
  outer color=transparent!100]

\usepackage[ruled]{algorithm2e}
\SetAlgorithmName{\footnotesize Algorithm}{\footnotesize Algorithm}{List of Algorithms}
...
\newlength{\imgh}
\newcommand{\rowlab}[1]{%
    \raisebox{\dimexpr0.5\imgh-0.5\height+0.5\depth}[\imgh][0pt]{%
    \footnotesize\shortstack{#1}}}
%----------------------------------------------------------------
